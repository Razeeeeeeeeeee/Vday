...
const RiddleCard = () => {
  ...
  return (
    <RouteProtection requiredClue="first-clue">
      ...
      <div className="min-h-screen bg-gradient-to-b from-[#FAFAFA] to-red-50 flex items-center justify-center p-4">
        <motion.div
          ...
          <Card className="bg-white rounded-3xl p-10 shadow-xl relative overflow-hidden">
            <AnimatePresence>
              {showSuccess && (
                <motion.div
                  ...
                  animate={{ opacity: 1 }}
                  exit={{ opacity: 0 }}
                  className="absolute inset-0 z-50 bg-red-50 flex flex-col items-center justify-center"
                >
                  <motion.div
                    animate={{
                      rotate: [0, -10, 10, -10, 0],
                  ...
                  >
                    <motion.div
                      className="w-32 h-24 bg-red-700 rounded-b-full relative"
                      animate={{
                        scale: [1, 1.05, 1],
                      }}
                      transition={{
                    ...
                    >
                      <motion.div
                        className="absolute -top-8 left-1/2 transform -translate-x-1/2 w-8 h-20 bg-red-600 rounded-full"
                        animate={{
                          rotate: [-20, 20, -20],
                          y: [0, 5, 0],
                        }}
            ...
            <CardContent className="space-y-8 text-center relative">
              <div className="relative">
                <motion.div className="flex justify-center items-center gap-4">
                  <motion.div
                    ...
                    className="relative"
                  >
                    <ChefHat className="w-12 h-12 text-red-600 relative z-10" />
                    <motion.div
                  ...
                  <motion.div
                    ...
                    className="relative"
                  >
                    <UtensilsCrossed className="w-8 h-8 text-red-400 relative z-10" />
                    <motion.div
              ...
              <motion.h1
                ...
                className="text-3xl font-light tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-red-900 to-red-600"
              >
              ...
              <motion.div
                variants={itemVariants}
                className="bg-gradient-to-br from-red-50 to-red-50/50 rounded-2xl p-8"
                whileHover={{
                  scale: 1.02,
                  boxShadow: "0 4px 15px rgba(0,0,0,0.05)",
                }}
              >
                <p className="text-md text-red-600 leading-relaxed space-y-2">
              ...
              <motion.button
                ...
                className="px-6 py-2.5 text-red-500 rounded-xl font-medium inline-flex items-center gap-2"
                whileHover={{
                  scale: 1.05,
              ...
              <AnimatePresence>
                {isHintVisible && (
                  ...
                  >
                    <motion.div
                      className="bg-red-50/50 rounded-2xl p-6 border border-red-100/50"
                      initial={{ y: 20 }}
                      animate={{ y: 0 }}
                    >
              ...
              <form onSubmit={handleSubmit} className="space-y-6 pt-4">
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="w-full px-6 py-3 rounded-xl focus:ring-2 focus:ring-red-400 bg-red-50/50"
                  />
                </div>

                <motion.button
                  type="submit"
                  className="px-8 py-3 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-xl font-medium inline-flex items-center gap-2 shadow-lg shadow-red-500/20"
                  whileHover={{
                    scale: 1.02,
